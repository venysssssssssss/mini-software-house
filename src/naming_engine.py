...
class NamingEngine:
    ...
    PATTERNS = {
        ...
        ProjectType.UNKNOWN: ["{tech} Project", "Project {tech}", "App {tech}", "{tech}Lab"],
    }
    ...
    def generate_batch(
        self, projects: List[Dict], context: str = None
    ...
    def _classify_project_type(
        self, files: List[str], dependencies: List[str], task_description: str = None
    ) -> ProjectType:
    ...
    def _estimate_complexity(
        self, files: List[str], dependencies: List[str], content_samples: Dict[str, str] = None
    ) -> ProjectComplexity:
    ...
    def _generate_kebab_name(
        self, task_description: str, project_type: ProjectType, features: List[str]
    ) -> str:
        """
    ...
    def _generate_description(
        self, project_type: ProjectType, analysis: Dict, features: List[str]
    ) -> str:
    ...
    def generate_project_name_from_task(
        self, task_description: str, project_type: str = None, dependencies: List[str] = None
    ) -> str:
        """
        ...
        analysis = self.analyze_project(
            files=files, dependencies=deps, task_description=task_description
        )
...
def load_project_metadata(workspace_path: str) -> Optional[Dict]:
    ...
    try:
        ...
        for root, dirs, filenames in os.walk(workspace_path):
            ...
            dirs[:] = [
                d for d in dirs if d not in {".git", "__pycache__", "node_modules", ".pytest_cache"}
            ]
...
if __name__ == "__main__":
    ...
    name, description = engine.generate_name(
        analysis, task_description="Build a REST API for user management with PostgreSQL database"
    )
    ...
    name, description = engine.generate_name(
        analysis, task_description="Create a real-time chat application with WebSocket support"
    )
    print(f"  Project Name: {name}")
    print(f"  Description: {description}")
